    ...
    <div className="flex-row bg-[#1a1a1a] pt-[4rem] pr-0 pb-[4rem] pl-[6rem] flex__center">
      <div className="flex-1 flex justify-center gap-3 items-start flex-col min-w-[500px] pr-[2rem]">
        ...
        <p className="p__opensans" style={{ color: "#AAAAAA" }}>
          In our photo gallery, you will find a captivating collection of
          visually stunning images that showcase the beauty, ambiance, and
          delectable offerings of our establishment. Each photograph tells a
          story, capturing the essence of our restaurants exquisite dishes,
          elegant interior design, and the joyous moments shared by our guests.
        </p>
        <button
          type="button"
      ...
      <div className="flex-1 flex flex-row max-w-[50%] relative">
        <div className="flex flex-row w-max overflow-x-scroll" ref={scrollRef}>
          {[
            images.gallery01,
            images.gallery02,
            images.gallery03,
            ...
            >
              <img
                ...
                alt="gallery_image"
              />
              <BsInstagram className="absolute text-[#fff] text-[2rem] opacity-0 ease-linear duration-75 cursor-pointer hover:opacity-100" />
            </div>
          ))}
        </div>
